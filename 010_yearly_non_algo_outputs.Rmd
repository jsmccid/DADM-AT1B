...
outputy1$cap_p_gross <- cap_y1_s1
outputy1$searches <- searches
outputy1$searchesneeded <- searchesneeded
outputy1$discovered <- discovered
outputy1$cap_m_search <- cap_y1_s2
outputy1$cap_m_fixed_costs <- cap_y1_s3
outputy1$cap_m_legalfees <- cap_y1_s4
outputy1$choose_resolution <- goresolve
outputy1$successful_resolution <- res_if_success
soutputy1$succes <- res_succ
outputy1$lost_mine <- lost_mine
outputy1$goldhold <- goldhold
outputy1$cap_m_goldbuy <- cap_y1_s5
