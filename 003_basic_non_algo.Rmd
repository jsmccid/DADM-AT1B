...
maxteam <- cap_y1_s1 / cost_of_freelance
minteam <- 0

# random distribution of teams for that year
calcteam <- floor(runif(num_sim, minteam, maxteam))
...
# calculate number of searches
maxteam <- abs(cap_y2_s2) / cost_of_freelance
...
# calculate number of searches
maxteam <- abs(cap_y3_s2) / cost_of_freelance
minteam <- 0
...
# calculate number of searches
maxteam <- abs(cap_y4_s2) / cost_of_freelance
minteam <- 0
...
# calculate number of searches
maxteam <- abs(cap_y5_s2) / cost_of_freelance
minteam <- 0
